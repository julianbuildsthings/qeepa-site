...
3. Add a build **environment variable** `SITE` set to the production origin,
   e.g. `SITE=https://qeepa.com`. This is used for canonical and Open Graph
   URLs, so without it those tags fall back to `http://localhost:4321`.
